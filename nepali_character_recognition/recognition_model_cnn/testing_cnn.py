...
model = load_model('recognition_model_cnn.keras')

# Define a mapping of class indices to Nepali characters and phonetics
class_mapping = {
    ...
    46: {'devanagari': '्/अ', 'phonetics': 'virāma'},
    ...
    56: {'devanagari': 'ं/अं', 'phonetics': 'ṁ'},
    57: {'devanagari': 'ः/अः', 'phonetics': 'ḥ'},
